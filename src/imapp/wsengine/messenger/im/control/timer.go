...
import (
	...
	event2 "ws/framework/application/core/action/event"
	"ws/framework/application/core/notification/event"
...
func initTimerProcessor(channel containerInterface.IMessageChannel) {
	...
	channel.AddMessageProcessor(processor.NewTimerProcessor(
		func() []containerInterface.IAction {
			return []containerInterface.IAction{&event2.UploadChannel0Event{}}
		},
	...
	channel.AddMessageProcessor(processor.NewTimerProcessor(
		func() []containerInterface.IAction {
			return []containerInterface.IAction{&event2.UploadChannel2Event{}}
		},
