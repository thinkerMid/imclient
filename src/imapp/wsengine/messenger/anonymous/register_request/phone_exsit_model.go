...
func MakePhoneExistBody(appIocContainer containerInterface.IAppIocContainer) string {
	...
	phoneExistModel.Id = utils.URLEncode(functionTools.B2S(reverToken.RecoveryToken))
	phoneExistModel.BackupToken = utils.URLEncode(functionTools.B2S(reverToken.BackupToken))
