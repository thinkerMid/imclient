...
func MakePhoneGetSmsCodeBody(appIocContainer containerInterface.IAppIocContainer) string {
	...
	phoneGetCodeModel.Id = utils.URLEncode(functionTools.B2S(reverToken.RecoveryToken))
	phoneGetCodeModel.BackupToken = utils.URLEncode(functionTools.B2S(reverToken.BackupToken))
