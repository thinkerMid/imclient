...
// UploadPreKeyToServer 上传密钥到服务器
type UploadPreKeyToServer struct {
...
// Start .
func (s *UploadPreKeyToServer) Start(context containerInterface.IMessageContext, _ containerInterface.NextActionFn) (err error) {
...
// Receive .
func (s *UploadPreKeyToServer) Receive(context containerInterface.IMessageContext, next containerInterface.NextActionFn) (err error) {
	next()
...
// Error .
func (s *UploadPreKeyToServer) Error(_ containerInterface.IMessageContext, _ error) {}
