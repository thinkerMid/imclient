...
func (c *Conn) WriteByte(b byte) (err error) {
	buf, err := c.Malloc(1)
	if err != nil {
		return err
	}
...
func (c *Conn) WriteDirect(p []byte, remainCap int) error {
	//TODO implement me
	panic("implement me")
}

func (c *Conn) MallocAck(n int) (err error) {
	//TODO implement me
	panic("implement me")
}

func (c *Conn) Append(w netpoll.Writer) (err error) {
	//TODO implement me
	panic("implement me")
}

func (c *Conn) MallocLen() (length int) {
	//TODO implement me
	panic("implement me")
}

func (c *Conn) Next(n int) (p []byte, err error) {
	p, err = c.Peek(n)
	if err != nil {
		return
	}
...
func (c *Conn) Until(delim byte) (line []byte, err error) {
	//TODO implement me
	panic("implement me")
}

func (c *Conn) ReadString(n int) (s string, err error) {
	//TODO implement me
	panic("implement me")
}

func (c *Conn) Slice(n int) (r netpoll.Reader, err error) {
	//TODO implement me
	panic("implement me")
}

func (c *Conn) Reader() netpoll.Reader {
	return c
}

func (c *Conn) Writer() netpoll.Writer {
	return c
}

func (c *Conn) IsActive() bool {
	return c.c.LocalAddr() != nil
}

func (c *Conn) SetIdleTimeout(timeout time.Duration) error {
	return nil
}

func (c *Conn) SetOnRequest(on netpoll.OnRequest) error {
	return nil
}

func (c *Conn) AddCloseCallback(callback netpoll.CloseCallback) error {
	return nil
}
