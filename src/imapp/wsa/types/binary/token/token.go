...
func init() {
	st := []string{"xmlstreamstart",
		...
		"8000",
		"acs_public_key",
		"sigquit_anr_detector_release_rollover_p",
		...
		"mms4_media_retry_notification_encryptio",
		"timeout",
		...
		"mms4_server_error_receipt_encryption_en",
		"vid_rc_dyn",
		"fri",
		...
		"media_upload_aggressive_retry_exponenti",
		"tue",
		"wed",
		...
		"sigquit_anr_detector_64bit_rollover_per",
		...
		"reconnecting_after_network_change_thres",
		...
		"android_privatestats_endpoint_dit_enabl",
		...
		"groups",
		"sigquit_anr_detector_release_updated_ro",
		...
		"watls_early_data",
		"reconnecting_before_relay_failover_thre",
		...
		"smb_better_catalog_list_adapters_enable",
		...
		"reconnecting_before_network_change_thre",
		...
		"sticker_tray_animation_fully_visible_it",
		"green_alert_banner_duration",
		"reconnecting_after_p2p_failover_thresho",
		"connected",
		...
		"reconnecting_after_relay_failover_thres",
		"false",
		"group",
		"sun",
		...
		"reconnecting_after_call_active_threshol",
		"1140",
	...
	SingleByteTokens = append(SingleByteTokens, "")

	st1 := st[0:235]
	st2 := st[235:]
	for _, s := range st1 {
		SingleByteTokens = append(SingleByteTokens, s)
	}
	n := len(st2) / 255
	index := 0
	for i := 0; i < n; i++ {
		...
		for d := 0; d <= 255; d++ {
			...
			tmpArr = append(tmpArr, st2[index])
			index += 1
		}
		DoubleByteTokens = append(DoubleByteTokens, tmpArr)
	}
