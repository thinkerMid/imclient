...
import (
	...
	"labs/src/imapp/wsa/types/record"
	"labs/utils"
	"math"
	"time"
)
...
func GenerateRegistrationID() uint32 {
	// 				0xFFFFFF(16777215) < ID < math.MaxUint32
	return uint32(utils.RandInt64(16777215, math.MaxUint32))
}

// GenerateSignedPreKeyID generates a registration ID. Clients should only do
// this once, at install time.
func GenerateSignedPreKeyID() uint32 {
	// 				100000 < ID < 0xFFFFFF(16777215)
	return uint32(utils.RandInt64(100000, 16777215))
}
